...
class AdventOfCode2022
{
    ...
    private static int dayOne( Stream<String> input, int numberOfElves )
    {
    ...
    private static int dayTwoPart1( Stream<String> input )
    {
    ...
    private static int dayTwoPart2( Stream<String> input )
    {
        return input.map(
    ...
    private static int dayThreePart2( Stream<String> input )
    {
    ...
    private static boolean isInPack( String backpack, int type )
    {
    ...
    final static Pattern day4Pattern = Pattern.compile( "([0-9]+)-([0-9]+),([0-9]+)-([0-9]+)", Pattern.MULTILINE );
    ...
    private static long dayFourPart2( Stream<String> input )
    {
        return input.map( AdventOfCode2022::parseInputDay4 ).filter( Objects::nonNull ).filter(
            pair -> overlap(pair.foo, pair.bar ) ||  contains(pair.foo, pair.bar )).count();
    }

    private static Pair parseInputDay4( String input )
    {
    ...
    static boolean contains(Coordinates foo, Coordinates bar) { return foo.x <= bar.x && foo.y >= bar.y; }
    static boolean overlap( Coordinates foo, Coordinates bar ) { return foo.x <= bar.x && bar.x <= foo.y; }
    ...
    private static int day6Part1( Stream<String> input )
    {
    ...
    //-------------- DAY 7: Directories -------------------
    private static int day7Part1( Stream<String> input )
    {
    ...
    private static int getMaxSize( Set<Coordinates> visibleTrees, int[][] treePatch, int row, int col, int maxSizeForRow )
    {
    ...
    private static Integer scenicScore( int[][] treePatch, int row, int col )
    {
    ...
    private static boolean lastTree( int[][] treePatch, int treeSize, int row, int col, boolean checkRow ){
        return (checkRow ? (row==0 || row==treePatch.length-1) : (col==0 || col==treePatch[row].length-1))
            || treePatch[row][col] >= treeSize;
    }

    //-------------- DAY 9: moving ropes -------------------
    private static int day9Part1( Stream<String> input )
    {
    ...
    static long day11Part1(Stream<String> input){
        ...
        return monkeys.stream().peek( System.out::println ).map( Monkey::getBusiness ).sorted(Comparator.reverseOrder()).limit(2).reduce( 1L , ( a, b)-> a *  b );
    }
    ...
    private static Coordinates findPosition(char search )
    {
        for( int x = 0; x< HILL.length; x++){
            for( int y = 0; y< HILL[0].length; y++){
    ...
    private static List<Coordinates> findAllPositions(char search )
    {
    ...
    //-------------- DAY 13 SOS Packets -------------------
    private static int day13Part1(Stream<String> input){
    ...
    private static int day13Part2(Stream<String> input){
    ...
    //-------------- DAY 14 Falling Sand -------------------
    private static int day14(Stream<String> input)
    {
    ...
    enum Direction { same, north, south, east, west}
    static class Coordinates {
        ...
        Coordinates(int x, int y) { this(x,y,0, null); }
        Coordinates(int x, int y, int value) { this(x,y,value, null); }
    ...
    public static void main( String[] args )
        throws Exception
    {
        String path = "C:\\Users\\{ME}\\Downloads\\";

        if ( false )
        {            
            System.out.println( "Calories: " + dayOne( Files.lines( Paths.get( path + "day1-input.txt" ) ), 3 ) );
            System.out.println( "Score1: " + dayTwoPart1( Files.lines( Paths.get( path + "day2-input.txt" ) ) ) );
            System.out.println( "Score2: " + dayTwoPart2( Files.lines( Paths.get( path + "day2-input.txt" ) ) ) );
            System.out.println( "Mistakes: " + dayThreePart1( Files.lines( Paths.get( path + "day3-input.txt" ) ) ) );
            System.out.println( "Badges: " + dayThreePart2( Files.lines( Paths.get( "path+\"day3-input.txt" ) ) ) );
            System.out.println( "Contains: " + dayFourPart1( Files.lines( Paths.get( path + "day4-input.txt" ) ) ) );
            System.out.println( "Overlaps: " + dayFourPart2( Files.lines( Paths.get( path + "day4-input.txt" ) ) ) );
            System.out.println( "Something: " + day5Part1( Files.lines( Paths.get( path + "day5-input.txt" ) ) ) );
            System.out.println( "Something: " + day6Part1( Files.lines( Paths.get( path + "day6-input.txt" ) ) ) );
            System.out.println( "Directory: " + day7Part1( Files.lines( Paths.get( path + "day7-input.txt" ) ) ) );
            System.out.println( "Trees: " + day8Part1( Files.lines( Paths.get( path + "day8-input.txt" ) ) ) );
            System.out.println( "Scenery: " + day8Part2( Files.lines( Paths.get( path + "day8-input.txt" ) ) ) );
            System.out.println( "Positions: " + day9Part1( Files.lines( Paths.get( path + "day9-input.txt" ) ) ) );
            System.out.println( "Frequency: " + day10Part1( Files.lines( Paths.get( path + "day10-input.txt" ) ) ) );
            System.out.println( "Monkey: " + day11Part1( Files.lines( Paths.get( path + "day11-input.txt" ) ) ) );
            System.out.println( "Steps: " + day12Part1( Files.lines( Paths.get( path + "day12-input.txt" ) ) ) );
            System.out.println( "Order: " + day13Part1( Files.lines( Paths.get( path + "day13-input.txt" ) ) ) );
            System.out.println( "Order: " + day13Part2( Files.lines( Paths.get( path + "day13-input.txt" ) ) ) );
